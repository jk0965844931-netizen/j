...
- **PiP Overlay** — หน้าต่างลอยที่แสดงคำแปลข้ามแอพได้ พร้อม host layer สำหรับเปิด PiP ได้เสถียรขึ้น
...
2. ถ้าต้องการแปลเสียงจาก YouTube หรือแอพอื่น ให้เลือกโหมด **เสียงระบบ** แล้วกดปุ่ม Screen Broadcast
3. เลือก **VoiceTranslator Broadcast** และเริ่มถ่ายทอด จากนั้นกลับไปแอพที่ต้องการฟัง
4. กดปุ่ม **PiP** (⊞) มุมขวาบน เพื่อเปิดหน้าต่างคำแปลลอย
5. คำแปลจะปรากฏในหน้าต่าง PiP แบบ floating และอัปเดตแบบเรียลไทม์
6. กด **Home** เพื่อซ่อนแอพ — PiP ยังแสดงผลอยู่ และลากหน้าต่าง PiP ไปวางตำแหน่งที่ต้องการ
